...
<html lang="en">
    ...
    <body>
        ...
        <div id="loginbox">            
            <form id="loginform" class="form-vertical" action="userAction_login"  method="post"/>
				<p>欢迎登录毕业论文管理系统</p>
            ...
            <form id="recoverform" action="userAction_recover" class="form-vertical" method="post" />
            <p>请输入您的用户名和邮箱</p>
                <div class="control-group">
                    <div class="controls">
                        <div class="input-prepend">
