					...
					<div class="span12">
						<div class="widget-box">
							...
							<div class="widget-content nopadding">
								<form class="form-horizontal" method="post" action="topicAction_input" name="basic_validate" id="basic_validate" novalidate="novalidate" >
									...
									<div class="control-group">
										...
										<div class="controls">
											<label><input type="radio" name="topic.type" value="论文" checked="checked"/> 论文</label>
											<label><input type="radio" name="topic.type" value="其他"/> 其他</label>
										</div>
									</div>
									<div class="control-group">
									...
									<div class="control-group">
										...
										<div class="controls">
											<label><input type="radio" name="topic.isTrial" value="是" checked="checked"/> 是</label>
											<label><input type="radio" name="topic.isTrial" value="否"/> 否</label>
										</div>
									</div>
									<div class="control-group">
										<label class="control-label">是否应用类</label>
										<div class="controls">
											<label><input type="radio" name="topic.isAnswer" value="是" checked="checked"/> 是</label>
											<label><input type="radio" name="topic.isAnswer" value="否"/> 否</label>
										</div>
									</div>
									<div class="control-group">
										<label class="control-label">是否导师在研项目</label>
										<div class="controls">
											<label><input type="radio" name="topic.isTutorWork" value="是" checked="checked"/> 是</label>
											<label><input type="radio" name="topic.isTutorWork" value="否"/> 否</label>
										</div>
									</div>

                                    <div class="form-actions">
                                        <input type="submit" value="申报" class="btn btn-primary" />
                                    </div>
                                </form>
							</div>
						</div>			
