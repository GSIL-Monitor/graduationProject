...
function onloadVal(){
    ...
    if( ret == 0 ){
        ...
        // 通过Post 形式向服务器发送数据 .
        var url = "http://localhost:8080/adminAction_teaModifyVal" ;
        xhr.open( "post" , url ) ;
...
function processResult(){
    ...
    var teacher_id=getElement("teacher_id");
    teacher_id.value=json.teacher_id;
    var teacher_no=getElement("teacher_no");
    teacher_no.value=json.teacher_no;
